...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const arbitrationList = common_vendor.ref([
      {
        id: "ARB20260222001",
        order_no: "ORD20260220008",
        dispute_type: "货款纠纷",
        description: "农户供货后，回收款项已超约定支付期限，农户要求仲裁介入催款。",
        status: "pending",
        result: null,
        created_at: "2026-02-22 10:15"
      },
      {
        id: "ARB20260210002",
        order_no: "ORD20260205012",
        dispute_type: "运输损耗",
        description: "柑橘在运输途中损耗超出约定比例，双方对损耗责任归属存在争议。",
        status: "processing",
        result: null,
        created_at: "2026-02-10 16:30"
      },
      {
        id: "ARB20260120003",
        order_no: "ORD20260117003",
        dispute_type: "重量争议",
        description: "农户方磅与回收商地磅数据差异超过3%，双方无法达成一致。",
        status: "resolved",
        result: "经第三方公证称重，认定差异在合理误差范围内，双方各承担一半损耗。",
        created_at: "2026-01-20 09:00"
      }
    ]);
    const toggleForm = () => {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-91ec6f16"], ["__file", "C:/Users/lkf12/WeChatProjects/project-recycle/xianyu-farmer-version-/src/pages/merchant/arbitration/index.vue"]]);
